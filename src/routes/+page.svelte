    ...
    <div class="mt-4 grid-cols-5 gap-8 md:grid">
        ...
        <div class="col-span-3">
            <p class="mt-2 md:mt-0">
                The internet is filled with half-hearted applications that allow users to see data, but no clear
                actionable outcome. You know what? Those applications don&apos;t lead to insights or engagement, and
                they don&apos;t lead to greater impact.
                <br />
                <br />
                In contrast, I focus on impact from the start: how the application or tool effectively meets a real need
                and can measurably increase real impact. Is your goal to change user behavior and lead to real on-the-ground
                activities? Then whatever I build collaboratively with you needs to be strongly aligned around reaching that
                goal.
                <br />
                <br />
                What this means for you:
    ...
    <div class="mt-4 grid-cols-5 gap-8 md:grid">
        <div class="col-span-3">
            <p class="mt-2 md:mt-0">
                ...
                highly successful at working independently, a highly successful project is the result of us working
                closely together to clearly identify needs and context, running experiments to explore possible
                solutions, and clearly targeting the impact you want to achieve through every stage of the project.
                <br />
                <br />
                What this means for you:
            </p>
        ...
        <div class="col-span-2 mt-4 pt-2 md:mt-0">
            <enhanced:img src="$lib/assets/images/helloquence-61189-unsplash.jpg" alt="hands and notepad" />
        </div>
    </div>
    ...
    <div class="mt-4 grid-cols-5 gap-8 md:grid">
        ...
        <div class="col-span-3">
            <p class="mt-2 md:mt-0">
                ...
                <br />
                <br />
                Instead, I focus on distilling things down as much as possible, to create a simple, intuitive experience.
                In practice, this is very difficult: simplicity is significantly more valuable over the long term than complexity,
                and also significantly harder to achieve.
                <br /><br />
                What this means for you:
            </p>
            <ul class="mt-2">
                <li>
                    ...
                    less hyped solution is far superior over the long term.
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="mt-4 grid-cols-5 gap-8 md:grid">
        <div class="col-span-3">
            <p class="mt-2 md:mt-0">
                ...
                openly sharing something of value, we get something in return. I&apos;m not an open-source zealot
                though, so I will work with you to find the right balance for your project. In practice, many of the
                libraries I create are open source, and some of the applications I create for clients are not.
                <br /><br />
                What this means for you:
            </p>
            <ul class="mt-2">
                <li>
                    ...
                    ways to generalize our work into new libraries, because I firmly believe that is a better value to
                    you over the long term.
                </li>
            </ul>
        </div>
        <div class="col-span-2 mt-4 pt-2 md:mt-0">
            <enhanced:img src="$lib/assets/images/43698185622_500965906c_k.jpg" alt="crayfish" />
        </div>
    </div>
</div>
