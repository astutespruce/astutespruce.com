...
const Projects = ({ data: { banner, allMdx } }) => {
    ...
    return (
        <Layout>
            <SEO title="Projects" description="Astute Spruce projects" extra={{ slug: 'projects' }} />

            <BannerImage src={banner} credit="Kimberly Farmer" url="https://unsplash.com/photos/lUaaKCUANVI" />
...
export const pageQuery = graphql`
    query {
        banner: file(relativePath: { eq: "kimberly-farmer-lUaaKCUANVI-unsplash.jpg" }) {
            childImageSharp {
                fluid(maxWidth: 3200) {
